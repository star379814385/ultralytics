...
class FasterNet(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        # logger = logging.Logger("tmp")
        if self.init_cfg is None and pretrained is None:
            logging.warn(f'No pre-trained weights for '
...
pretrained_paths = {
    "FasterNet_S": r"D:\pretrained_model\fasternet\fasternet_s-epoch.299-val_acc1.81.2840.pth",
}

class FasterNet_S(FasterNet):
    def __init__(
        self,
        c1=0,
        c2=0,
        ...
        **kwargs,
        ...
        super(FasterNet_S, self).__init__(
            mlp_ratio=mlp_ratio,
            embed_dim=embed_dim,
            depths=depths,
            ...
            act_layer=act_layer,
            fork_feat=fork_feat,
            init_cfg=dict(checkpoint=pretrained_paths.get("FasterNet_S", None)),
            **kwargs
        )

class FasterNet_M(FasterNet):
    def __init__(
        self,
        c1=0,
        c2=0,
        ...
        **kwargs,
        ...
        super(FasterNet_S, self).__init__(
            ...
            act_layer=act_layer,
            fork_feat=fork_feat,
            init_cfg=dict(checkpoint=pretrained_paths.get("FasterNet_M", None)),
            **kwargs
        )

class FasterNet_L(FasterNet):
    def __init__(
        self,
        c1=0,
        c2=0,
        ...
        **kwargs,
        ...
        super(FasterNet_S, self).__init__(
            ...
            act_layer=act_layer,
            fork_feat=fork_feat,
            init_cfg=dict(checkpoint=pretrained_paths.get("FasterNet_L", None)),
            **kwargs
        )
